...
const get_profiles = async function(gender, cards_container, loader_icon) {
    const res = await fetch(`https://api.betterhalf.ai/v2/search-users?limit=12&gender=${gender}&${data_obj.parameter}=${data_obj.value}`);
    try {
...
},{}]},["gAoaA","6rimH"], "6rimH", "parcelRequire258f")
